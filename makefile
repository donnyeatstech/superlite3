...
debug: src/main.c src/os/os.c src/os/backend.h src/os/real_backend.c
	$(CC) $(CFLAGS) -o superlite_gdb src/main.c src/os/os.c src/os/real_backend.c -g

test: tests/test_main.c src/os/os.c src/os/backend.h src/os/real_backend.c tests/os/test_backend.c
	$(CC) $(CFLAGS) -o superlite_test tests/test_main.c src/os/os.c src/os/real_backend.c tests/os/test_backend.c
